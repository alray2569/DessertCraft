...
public final class DCRecipes {
	...
	public static void init() {
		...
		// CHERRY STAIRS
		GameRegistry
				.addRecipe(new ItemStack(DCBlocks.cherryStair, 4),
		...
		// GERMAN CAKE
		GameRegistry.addRecipe(new ShapedOreRecipe(DCItems.germanCake,
				new Object[] { "CCC", "WOW", 'C', "foodCherry", 'W',
						"cropWheat", 'O', new ItemStack(Items.dye, 1, 3) }));

		GameRegistry.addRecipe(new ShapedOreRecipe(DCItems.germanCake,
				new Object[] { "CCC", "WOW", 'C', "cropCherry", 'W',
						"cropWheat", 'O', new ItemStack(Items.dye, 1, 3) }));
		...
		IceCreamMakerRecipeRegistry.addRecipe(new ItemStack(
				DCItems.iceCream_chocolate), new ItemStack(Items.dye, 1, 3));
		// CHERRY ICE CREAM
		...
		// STRAWBERRY
		IceCreamMakerRecipeRegistry.addRecipe(new IceCreamMakerOreRecipe(
				new ItemStack(DCItems.iceCream_strawberry), "foodStrawberry"));
		IceCreamMakerRecipeRegistry
				.addRecipe(new IceCreamMakerOreRecipe(new ItemStack(
						DCItems.iceCream_strawberry), "foodStrawberries"));

		// PEANUT BUTTER
		IceCreamMakerRecipeRegistry.addRecipe(new IceCreamMakerOreRecipe(
				new ItemStack(DCItems.iceCream_peanutButter), "foodPeanut"));
		IceCreamMakerRecipeRegistry.addRecipe(new IceCreamMakerOreRecipe(
				new ItemStack(DCItems.iceCream_peanutButter), "foodPeanuts"));
		IceCreamMakerRecipeRegistry.addRecipe(new IceCreamMakerOreRecipe(
