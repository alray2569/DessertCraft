...
public class PastryCounterShapedRecipe implements IPastryCounterShapedRecipe {
	...
	public PastryCounterShapedRecipe(int par1, int par2,
	...
	public PastryCounterShapedRecipe func_92100_c() {
